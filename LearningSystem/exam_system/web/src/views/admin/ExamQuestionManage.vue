      ...
      <div class="demo-drawer__content" style="padding-right:40px;box-sizing: border-box">
        <el-form :model="formData" label-width="100px">
          ...
          <el-form-item label="题型" >
            <el-select v-model="formData.type" clearable placeholder="请选择" style="width: 100%" :disabled="formData.id!==undefined">
              <el-option v-for="item in questionType" :key="item" :label="item" :value="item" autocomplete="off"></el-option>
